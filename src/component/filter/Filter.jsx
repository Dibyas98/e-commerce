                ...
                <div className="p-5 bg-gray-100 border border-gray-200 rounded-lg drop-shadow-xl"
                    ...
                    <div className="relative">
                        ...
                        <input ref={searchRef}
                            ...
                            <button onClick={()=>handelSearch(searchRef.current.value)} className='flex items-center justify-center bg-red-500 rounded-md w-11 hover:bg-emerald-700' ><svg className="w-4 h-4 fill-current text-primary-gray-dark" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
